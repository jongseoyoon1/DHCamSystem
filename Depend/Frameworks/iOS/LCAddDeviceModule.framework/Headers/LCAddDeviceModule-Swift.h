...
typedef SWIFT_ENUM(NSInteger, CodeType, open) {
  CodeTypeSuccess = 200,
...
typedef SWIFT_ENUM(NSInteger, DHDeviceAccessType, open) {
...
/// 配网类型
typedef SWIFT_ENUM(NSInteger, DHNetConfigMode, open) {
...
typedef SWIFT_ENUM(NSInteger, DHNetConfigStrategy, open) {
...
/// 网络连接类型：对应NC码
typedef SWIFT_ENUM(NSInteger, DHNetConnectType, open) {
/// 没有NC码的
